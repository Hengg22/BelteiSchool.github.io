<?php include_once('adminpart.php') ?>
        <div class="col-lg-10 right-panel">
            ...
            <div class="row">
                ...
                INNER JOIN tblcampus ON tblcertificaterangdetail.CampusID=tblcampus.CampusID='1' where CertificateRangDetailID between 101 and 125";
                    echo '
               ...
               ';
                    ...
                    <ul class="pagination justify-content-center">
                        <li class="page-item">
                            <a class="page-link" href="alldata3.php" tabindex="-1">Previous</a>
                        </li>
                        ...
                        <li class="page-item">
                            <a class="page-link" href="alldata5.php">Next</a>
                        </li>
                    </ul>
                </nav>
                </div>
