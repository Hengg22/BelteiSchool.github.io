<?php include_once('adminpart.php') ?>
        <div class="col-lg-10 right-panel">
            ...
            <div class="row">
                ...
                INNER JOIN tblcampus ON tblcertificaterangdetail.CampusID=tblcampus.CampusID where CertificateRangDetailID between 76 and 100";
                    echo '
               ...
               ';
                    ...
                    <ul class="pagination justify-content-center">
                        <li class="page-item">
                            <a class="page-link" href="alldata2.php" tabindex="-1">Previous</a>
                        </li>
                        ...
                        <li class="page-item">
                            <a class="page-link" href="alldata4.php">Next</a>
                        </li>
                    </ul>
                </nav>
                </div>
