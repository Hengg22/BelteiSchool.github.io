<?php include_once('adminpart.php') ?>
        <div class="col-lg-10 right-panel">
            ...
            <div class="row">
                ...
                INNER JOIN tblcampus ON tblcertificaterangdetail.CampusID=tblcampus.CampusID where CertificateRangDetailID between 126 and 150";
                    echo '
               ...
               ';
                    ...
                    <ul class="pagination justify-content-center">
                        <li class="page-item">
                            <a class="page-link" href="alldata4.php" tabindex="-1">Previous</a>
                        </li>
                        ...
                        <li class="page-item disabled">
                            <a class="page-link" href="AllData.php">Next</a>
                        </li>
                    </ul>
                </nav>
                </div>
