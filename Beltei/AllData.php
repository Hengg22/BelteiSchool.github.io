    ...
    <div class="row pt-5 ">
        ...
        <div class="row">
            <div>
                ...
                INNER JOIN tblcampus ON tblcertificaterangdetail.CampusID=tblcampus.CampusID where CertificateRangDetailID between 1 and 25 ";
                echo '
                ...
                <nav aria-label="Page navigation example">
                    <ul class="pagination justify-content-center">
                        <li class="page-item disabled">
                            <a class="page-link" href="alldata5.php" tabindex="-1">Previous</a>
                        </li>
                        ...
                        <li class="page-item">
                            <a class="page-link" href="alldata1.php">Next</a>
                        </li>
                    </ul>
                </nav>
            </div>
