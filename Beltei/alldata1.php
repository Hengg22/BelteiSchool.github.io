<?php include_once('adminpart.php') ?>
        <div class="col-lg-10 right-panel">
            ...
            <div class="row">
                ...
                INNER JOIN tblcampus ON tblcertificaterangdetail.CampusID=tblcampus.CampusID='1' where CertificateRangDetailID between 26 and 50";
                    echo '
               ...
               ';
                    ...
                    <ul class="pagination justify-content-center">
                        <li class="page-item ">
                            <a class="page-link" href="AllData.php" tabindex="-1">Previous</a>
                        </li>
                        ...
                        <li class="page-item">
                            <a class="page-link" href="alldata2.php">Next</a>
                        </li>
                    </ul>
                </nav>
                </div>
